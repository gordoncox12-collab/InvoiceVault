package com.gordoncox.invoicevault.data.excel
...
@Suppress("unused")
fun customerStubFromRow(id: String, businessId: String, now: Long) = CustomerEntity(
    id = id,
...
@Suppress("unused")
fun invoiceStub(id: String, businessId: String, customerId: String, now: Long) = InvoiceEntity(
    id = id,
    businessId = businessId,
