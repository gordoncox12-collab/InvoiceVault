...
import com.gordoncox.invoicevault.InvoiceVaultApp
...
fun rememberAppContainer(): AppContainer {
    ...
    return remember(context) { (context.applicationContext as InvoiceVaultApp).container }
}

@Composable
inline fun <reified VM : ViewModel> vaultModel(crossinline create: (AppContainer) -> VM): VM {
